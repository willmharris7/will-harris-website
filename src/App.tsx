...
function App() {
  return (
    <div className="container-fluid">
      <Row>
        <Col xs={12} lg={6} className="text-center py-5">
          <p style={{fontSize: '4rem'}}>Hello! I'm Will</p>
        </Col>
        <Col xs={12} lg={6} className="text-center py-3">
      ...
      <Row>
        <Col xs={12} className="text-center py-3">This site is made with React and Bootstrap. Hosted on Vercel.</Col>
      </Row>
    </div>
  )
}
